...
def build_or_load_gen_model(args):
    ...
    if args.model_type == 'roberta':
        ...
        if args.compress == '8bit':
            model = model_class.from_pretrained(args.model_name_or_path, device_map="auto", load_in_8bit=True)
            print('Memory footprint:', model.get_memory_footprint())
        elif args.compress == 'deepspeed':
        ...
        elif args.compress == 'distillation':
            pass
        else:
