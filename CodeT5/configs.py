...
def add_args(parser):
    parser.add_argument("--task", type=str, required=True,
                        choices=['summarize', 'concode', 'concode_nl2py', 'translate', 'refine', 'defect', 'clone', 'multi_task'])
    ...
    parser.add_argument("--compress", type=str, choices=['None', '8bit', 'deepspeed', 'distillation'])
